...
ax.set_zlim(-5, 5)
# ax.set_zlim(0.1 - 3e-11, 0.1 + 3e-11)

ax.set_xlabel("x / ls")
ax.set_ylabel("y / ls")
ax.set_zlabel("z / ls")
ax.set_title("$E$- and $B$- Vector Field - Magnitudes not to scale")
...
ts = time.time()
fN = "../../graphs/EB/EB_example_" + datetime.datetime.fromtimestamp(ts).strftime('%Y-%m-%d-%H-%M-%S') + ".gif"
